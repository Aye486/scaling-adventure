...
class Background(GameSprite):
    ...
    def __init__(self,is_alt,*groups):
        ...
        if is_alt:
            self.rect.y = -self.rect.h    # 设置到游戏窗口正下方
            
    def update(self, *args):
        # 调用父类的方法实现向下运动
        super().update(*args)           # 向下运动
        # 判断是否移除屏幕，若移除屏幕，将图像设置到屏幕的上方
...
class Plane(GameSprite):
    ...
    def reset_plane(self):
        ...
        self.destroy_index = 0                  # 被摧毁状态图像索引9
...
class Enemy(Plane):
    ...
    def __init__(self, kind, max_speed, *groups):
        ...
        if kind == 0:
            ...
            super().__init__(6, 1, 600, "enemy2_down.wav",
                             ["enemy2.png"],
                             "enemy2_hit.png",
...
class Hero(Plane):
    ...
    def update(self,*args):
        """更新英雄飞机的图像及矩形区域
        ：param args：0更新图像标记，1水平移动基数，2垂直移动基数
        """
